...
class Sorts {
public:
    static SortMetric arr_sort(SortTask& task);
...
protected:
    ...
    static void merge_sort(std::vector<int32_t>& array, SortMetric& metric);
...
private:
    ...
    static void merge_sort_impl(std::vector<int32_t> &array, int32_t p, int32_t r, SortMetric &metric);

    static std::vector<int32_t> divide(const std::vector<std::vector<int32_t>>& subvector, int32_t left, int32_t right, SortMetric& metric);
    ...
    static void merge(std::vector<int32_t>& array, int32_t left, int32_t mid, int32_t right, SortMetric& metric);
};
