...
do
  for k in 1 10 100
  do
    ./bin/benchmark --mode rand --count $i --high $((2 * i - 1)) --strategy insertion --k $k >> dataset/insertion_k=$k
    ...
    ./bin/benchmark --mode rand --count $i --high $((2 * i - 1)) --strategy merge --k $k >> dataset/merge_k="$k"
...
do
  ...
  do
    ...
    ./bin/benchmark --mode rand --count $i --high $((2 * i - 1)) --strategy merge --k $k >> dataset/merge_k="$k"_long
